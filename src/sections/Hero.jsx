  ...
  return (
    <div className='flex flex-col text-mindWhite lg:w-full lg:items-center lg:justify-start h-screen mt-10 lg:mt-16 px-4 relative bg'>
        <div className='flex flex-col font-poppins items-start justify-start lg:items-center lg:justify-center lg:w-4/5  md:space-y-8'>
            <h3 className='text-xs mt-8 lg:mt-0 text-mindOrange font-poppins lg:text-2xl md:text-lg'>Experience  through AI-powered movie recommendation</h3>
            ...
            <h5 className='text-xs mt-4  lg:mt-0 w-[400px] lg:text-lg text-mindWhite font-poppins lg:px-24 lg:text-center lg:w-full md:mx-0 md:text-sm md:w-full'>Welcome to our AI-driven movie platform, where cutting-edge technology curates personalized film recommendations just for you. Start exploring today!</h5>
        ...
        <img src={""} className='object-contain w-[900px] mt-[85px] lg:-mt-[200px] lg:w-[600px]  lg:static md:w-[900px] md:mt-[160px] bg-transparent'/>
    </div>
 )
}
