...
const Overlay = () => {
  ...
  return (
    <div className='text-mindWhite h-full w-full z-[100] fixed left-0 top-0 bg-black opacity-90 duration-500 overflow-x-hidden' id='overlay'>
        ...
        <div className='absolute top-[20px] right-[45px] font-montserrat text-7xl cursor-pointer hover:text-mindOrange duration-300' onClick={handleClose}>
        &times;
        </div>
    </div>
  )
