    ...
    <div className='flex flex-col text-mindWhite lg:w-full lg:items-center lg:justify-start h-screen mt-10 lg:mt-16 px-4 relatives'>
       <div className='relative hidden flex-col -mt-6 lg:hidden' id='mobile-links'>
        ...
        <div className='flex flex-col font-poppins items-start justify-start lg:items-center lg:justify-center lg:w-4/5  md:space-y-8 gap-6 lg:gap-0 mt-4'>
            ...
            <a href='#films'><button className='mt-8 bg-mindWhite text-mindBlack px-8 py-3 hover:bg-mindOrange hover:text-mindWhite duration-200 font-poppins font-bold tracking-wider'>Watch</button></a>
        </div>
    </div>
 )
} 
